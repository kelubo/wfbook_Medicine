...
\begin{document}
	...
	\chapter{九针十二原}
	\begin{yuanwen}
	黄帝问于岐伯曰：余子万民\footnote{text}，养百姓\footnote{text}，而收其租税；余哀其不给而属有疾病\footnote{text}。余欲勿使被毒药\footnote{text}，无用砭石，欲以微针通其经脉，调其血气，荣其逆顺出入之会。令可传于后世，必明为之法，令终而不灭，久而不绝，易用难忘，为之经纪\footnote{text}，异其章，别其表里，为之终始。令各有形，先立《针经》。愿闻其情。
	\end{yuanwen}
	
	\begin{yuanwen}
	岐伯答曰：臣请推而次之，令有纲纪，始于一，终于九焉。请言其道！小针之要\footnote{text}，易陈而难入\footnote{text}。粗守形，上守神\footnote{text}。神乎神，客在门\footnote{text}。未睹其疾，恶知其原？刺之微，在速迟。粗守关，上守机\footnote{text}，机之动，不离其空\footnote{text}。空中之机，清静而微。其来不可逢，其往不可追\footnote{text}。知机之道者，不可挂以发\footnote{text}。不知机道，叩之不发。知其往来，要与之期。粗之（闇）暗乎，妙哉，工独有之。往者为逆，来者为顺\footnote{text}，明知逆顺，正行无问。逆而夺之，恶得无虚？追而济之，恶得无实？迎之随之，以意和之，针道毕矣。
	\end{yuanwen}
	
	\begin{yuanwen}
	凡用针者，虚则实之，满则泄之，宛陈则除\footnote{text}之，邪胜则虚之。《大要》曰：徐而疾则实\footnote{text}，疾而徐则虚\footnote{text}。言实与虚，若有若无\footnote{text}。察后与先\footnote{text}，若存若亡\footnote{text}。为虚与实，若得若失\footnote{text}。虚实之要，九针最妙。补泻之时，以针为之。泻曰：必持内之，放而出之\footnote{text}，排阳得针\footnote{text}，邪气得泄。按而引针，是谓内温\footnote{text}，血不得散，气不得出也。补曰：随之，随之，意若妄之\footnote{text}，若行若按\footnote{text}，如蚊虻止，如留如还，去如弦绝。令左属右\footnote{text}，其气故止，外门已闭，中气乃实。必无留血，急取诛之。持针之道，坚者为宝\footnote{text}。正指直刺，无针左右。神在秋毫，属意病者，审视血脉，刺之无殆。方刺之时，必在悬阳\footnote{text}，及与两卫\footnote{text}，神属勿去，知病存亡。血脉者，在腧\footnote{sh\`u}横居，视之独澄\footnote{text}，切之独坚。
	\end{yuanwen}
	
	\begin{yuanwen}
	九针之名，各不同形。一曰镵针\footnote{text}，长一寸六分；二曰员针，长一寸六分；三曰鍉针\footnote{text}，长三寸半；四曰锋针，长一寸六分；五曰铍针\footnote{text}，长四寸，广二分半；六曰员利针，长一寸六分；七曰毫针，长三寸六分；八曰长针，长七寸；九曰大针，长四寸。镵针者，头大末锐，去泻阳气；员针者，针如卵形，揩摩分间，不得伤肌肉者，以泻分气；鍉针者，锋如黍粟之锐，主按脉勿陷，以致其气；锋针者，刃三隅，以发痼疾；铍针者，末如剑锋，以取大脓；员利针者，尖如氂\footnote{m\'ao}，且员且锐，中身微大，以取暴气；毫针者，尖如蚊虻喙，静以徐往，微以久留之而养，以取痛痹；长针者，锋利身长，可以取远痹；大针者，尖如梃\footnote{text}，其锋微员，以泻机关之水也。九针毕矣。
	\end{yuanwen}
	
	\begin{yuanwen}
	夫气之在脉也，邪气在上\footnote{text}，浊气在中\footnote{text}，清气在下\footnote{text}。故针陷脉则邪气出\footnote{text}，针中脉则浊气出\footnote{text}，针太深则邪气反沉\footnote{text}，病益。故曰：皮肉筋脉，各有所处，病各有所宜，各不同形，各以任其所宜。无实无虚，损不足而益有余，是谓甚病，病益甚，取五脉者死\footnote{text}，取三脉者恇\footnote{text}；夺阴者死，夺阳者狂\footnote{text}，针害毕矣。刺之而气不至，无问其数。刺之而气至，乃去之，勿复针。针各有所宜，各不同形，各任其所为，刺之要，气至而有效，效之信，若风之吹云，明乎若见苍天。刺之道毕矣。	
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：愿闻五脏六腑所出之处\footnote{text}。
	
	岐伯曰：五脏五腧，五五二十五腧\footnote{text}；六腑六腧，六六三十六腧\footnote{text}。经脉十二，络脉十五\footnote{text}。凡二十七气，以上下。所出为井\footnote{text}，所溜为荥\footnote{text}，所注为输\footnote{text}，所行为经\footnote{text}，所入为合\footnote{text}。二十七气所行，皆在五腧也。节之交，三百六十五会。知其要者，一言而终；不知其要，流散无穷。所言节者，神气之所游行出入也，非皮肉筋骨也。
	\end{yuanwen}
	
	\begin{yuanwen}
	睹其色，察其目，知其散复。一其形，听其动静，知其邪正。右主推之\footnote{text}，左持而御之\footnote{text}，气至而去之\footnote{text}。凡将用针，必先诊脉，视气之剧易，乃可以治也。五脏之气已绝于内，而用针者反实其外，是谓重竭。重竭必死，其死也静。治之者辄反其气，取腋与膺。五脏之气已绝于外，而用针者反实其内，是谓逆厥。逆厥则必死，其死也躁。治之者反取四末。刺之害，中而不去，则精泄；不中而去，则致气。精泄则病益甚而恇，致气则生为痈疡。
	\end{yuanwen}
	
	\begin{yuanwen}
	五脏有六腑，六腑有十二原，十二原出于四关\footnote{text}，四关主治五脏。五脏有疾，当取之十二原。十二原者，五脏之所以禀三百六十五节之会也。五脏有疾也，应出十二原，而原各有所出，明知其原，睹其应，而知五脏之害矣。
	\end{yuanwen}
...
\end{yuanwen}
	...
	岐伯曰：身半以上者，邪中之也。身半已下者，湿中之也。故曰：邪之中人也，无有常。中于阴则溜于腑，中于阳则溜于经\footnote{text}。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：阴之与阳也，异名同类\footnote{text}，上下相会，经络之相贯，如环无端。邪之中人，或中于阴，或中于阳，上下左右，无有恒常，其故何也？
	...
	岐伯曰：中于阴者，常从臂胻始\footnote{text}。夫臂与胻，其阴皮薄，其肉淖泽\footnote{text}，故俱受于风，独伤其阴。
	\end{yuanwen}
	...
	岐伯曰：愁忧恐惧则伤心。形寒寒饮则伤肺\footnote{text}。以其两寒相感，中外皆伤，故气逆而上行。有所堕坠，恶血留内，若有所大怒，气上而不下，积于胁下则伤肝。有所击仆，若醉入房，汗出当风则伤脾。有所用力举重，若入房过度，汗出浴水则伤肾。
	...
	岐伯曰：虚邪之中身也\footnote{text}，洒淅动形。正邪之中人也微\footnote{text}，先见于色，不知于身，若有若无，若亡若存，有形无形，莫知其情。
	...
	岐伯答曰：夫色脉与尺之相应也，如桴鼓影响之相应也\footnote{text}，不得相失也，此亦本末根叶之殊候也，故根死则叶枯矣。色脉形肉不得相失也。故知一则为工，知二则为神，知三则神且明矣。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：愿卒闻之。
	
	岐伯答曰：色青者，其脉弦也\footnote{text}，赤者，其脉钩也\footnote{text}，黄者，其脉代也\footnote{text}，白者，其脉毛也\footnote{text}，黑者，其脉石\footnote{text}。见其色而不得其脉，反得其相胜之脉则死矣\footnote{text}；得其相生之脉则病已矣\footnote{text}。
	\end{yuanwen}
	...
	岐伯答曰：脉急者，尺之皮肤亦急；脉缓者，尺之皮肤亦缓；脉小者，尺之皮肤亦减而少；脉大者，尺之皮肤亦贲而起\footnote{text}；脉滑者，尺之皮肤亦滑；脉涩者，尺之皮肤亦涩。凡此变者，有微有甚，故善调尺者，不待于寸；善调脉者，不待于色。能参合而行之者，可以为上工，上工十全九。行二者为中工，中工十全七。行一者为下工，下工十全六。
	\end{yuanwen}
	...
	岐伯答曰：诸急者多寒\footnote{text}，缓者多热，大者多气少血，小者血气皆少，滑者阳气盛，微有热，涩者多血少气，微有寒。是故刺急者，深内而久留之\footnote{text}；刺缓者，浅内而疾发针\footnote{text}，以去其热；刺大者，微泻其气，无出其血；刺滑者，疾发针而浅内之，以泻其阳气而去其热；刺涩者，必中其脉，随其逆顺而久留之，必先按而循之，已发针，疾按其痏\footnote{text}，无令其血出，以和其脉；诸小者，阴阳形气俱不足，勿取以针，而调以甘药也。
	\end{yuanwen}
	...
	岐伯答曰：取之三里者，低跗取之\footnote{text}；巨虚者，举足取之；委阳者，屈伸而索之；委中者，屈而取之；阳陵泉者，正竖膝，予之齐\footnote{text}，下至委阳之阳取之；取诸外经者，揄申而从之\footnote{text}。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：愿闻六腑之病。
	
	岐伯答曰：面热者，足阳明病；鱼络血者\footnote{text}，手阳明病；两跗之上脉竖陷者，足阳明病。此胃脉也。
	\end{yuanwen}
	
	\begin{yuanwen}
	大肠病者，肠中切痛而鸣濯濯\footnote{text}。冬日重感于寒即泄，当脐而痛，不能久立。与胃同候，取巨虚上廉。
	\end{yuanwen}
	...
	\begin{yuanwen}
	小肠病者，小腹痛，腰脊控睾而痛，时窘之后\footnote{text}，当耳前热，若寒甚，若独肩上热甚，及手小指次指之间热，若脉陷者，此其候也。手太阳病也，取之巨虚下廉。
	\end{yuanwen}
	...
	\begin{yuanwen}
	胆病者，善太息，口苦，呕宿汁，心下澹澹恐人将捕之\footnote{text}，嗌中吤吤然\footnote{text}，数唾。在足少阳之本末，亦视其脉之陷下者灸之，其寒热者取阳陵泉。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：刺之有道乎？
	
	岐伯答曰：刺此者，必中气穴\footnote{text}，无中肉节\footnote{text}。中气穴则针游于巷\footnote{text}；中肉节即皮肤痛。补泻反则病益笃，中筋则筋缓，邪气不出，与其真相搏，乱而不去，反还内著。用针不审，以顺为逆也。
	\end{yuanwen}
	...
	\chapter{寿夭刚柔}
	\begin{yuanwen}
	黄帝问于少师曰\footnote{text}：余闻人之生也，有刚有柔，有弱有强，有短有长，有阴有阳，愿闻其方。
	
	少师答曰：阴中有阴，阳中有阳，审知阴阳，刺之有方。得病所始，刺之有理。谨度病端\footnote{text}，与时相应。内合于五脏六腑，外合于筋骨皮肤。是故内有阴阳，外亦有阴阳。在内者，五脏为阴，六腑为阳，在外者，筋骨为阴，皮肤为阳。故曰，病在阴之阴者\footnote{text}，刺阴之荥输，病在阳之阳者\footnote{text}，刺阳之合，病在阳之阴者\footnote{text}，刺阴之经，病在阴之阳者\footnote{text}，刺络脉。故曰，病在阳者命曰风，病在阴者命曰痹，阴阳俱病命曰风痹。病有形而不痛者，阳之类也；无形而痛者，阴之类也。无形而痛者，其阳完而阴伤之也，急治其阴，无攻其阳。有形而不痛者，其阴完而阳伤之也，急治其阳，无攻其阴。阴阳俱动，乍有形，乍无形，加以烦心，命曰阴胜其阳。此谓不表不里，其形不久\footnote{text}。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝问于伯高\footnote{text}曰：余闻形气，病之先后、外内之应，奈何？
	...
	伯高答曰：病九日者，三刺而已；病一月者，十刺而已；多少远近，以此衰之\footnote{text}。久痹不去身者\footnote{text}，视其血络，尽出其血。
	...
	伯高答曰：形与气相任则寿\footnote{text}，不相任则夭。皮与肉相裹则寿，不相裹则夭，血气经络胜形则寿\footnote{text}，不胜形则夭。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：何谓形之缓急？
	
	伯高答曰：形充而皮肤缓者则寿，形充而皮肤急者则夭。形充而脉坚大者顺也，形充而脉小以弱者气衰，衰则危矣。若形充而颧不起者骨小，骨小则夭矣。形充而大肉䐃\footnote{ji\v{o}ng}坚而有分者肉坚\footnote{text}，肉坚则寿矣；形充而大肉无分理不坚者肉脆，肉脆则夭矣。此天之生命，所以立形定气而视寿夭者，必明乎此立形定气，而后以临病人，决死生。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：余闻寿夭，无以度之。
	
	伯高答曰：墙基卑，高不及其地者\footnote{text}，不满三十而死。其有因加疾者，不及二十而死也。
	...
	\begin{yuanwen}
	黄帝问于岐伯曰：凡刺之法，先必本于神\footnote{text}。血、脉、营、气、精、神，此五脏之所藏也。至其淫泆离脏则精失\footnote{text}，魂魄飞扬\footnote{text}，志意恍乱\footnote{text}，智虑去身者，何因而然乎？天之罪与？人之过乎？何谓德、气、生、精、神、魂、魄、心、意、志、思、智、虑\footnote{text}？请问其故。
	
	岐伯答曰：天之在我者，德也，地之在我者，气也。德流气薄而生者也\footnote{text}。故生之来谓之精，两精相搏谓之神\footnote{text}；随神往来者谓之魂；并精而出入者谓之魄；所以任物者谓之心\footnote{text}；心有所忆谓之意；意之所存谓之志；因志而存变谓之思；因思而远慕谓之虑；因虑而处物谓之智。
	\end{yuanwen}
	
	\begin{yuanwen}
	故智者之养生也，必顺四时而适寒暑，和喜怒而安居处，节阴阳而调刚柔，如是则僻邪不至，长生久视\footnote{text}。
	\end{yuanwen}
	
	\begin{yuanwen}
	是故怵惕思虑者则伤神\footnote{text}，神伤则恐惧，流淫而不止\footnote{text}。因悲哀动中者，竭绝而失生\footnote{text}。喜乐者，神惮散而不藏\footnote{text}。愁忧者，气闭塞而不行。盛怒者，迷惑而不治\footnote{text}。恐惧者，神荡惮而不收\footnote{text}。
	\end{yuanwen}
	...
	\begin{yuanwen}
	脾，愁忧不解则伤意，意伤则悗乱\footnote{text}，四肢不举，毛悴色夭，死于春。
	\end{yuanwen}
	...
	\begin{yuanwen}
	肝藏血，血舍魂\footnote{text}。肝气虚则恐，实则怒。脾藏营，营舍意。脾气虚则四肢不用，五脏不安，实则腹胀，经溲不利\footnote{text}。心藏脉，脉舍神，心气虚则悲，实则笑不休。肺藏气，气舍魄，肺气虚，则鼻塞不利，少气，实则喘喝，胸盈仰息。肾藏精，精舍志，肾气虚则厥，实则胀，五脏不安。必审五脏之病形，以知其气之虚实，谨而调之也。
	\end{yuanwen}

	\chapter{终始}
	
	\begin{yuanwen}
	凡刺之道，毕于《终始》。明知终始，五脏为纪\footnote{text}，阴阳定矣。阴者主脏，阳者主腑。阳受气于四末，阴受气于五脏\footnote{text}。故泻者迎之，补者随之。知迎知随，气可令和。和气之方，必通阴阳。五脏为阴，六腑为阳。传之后世，以血为盟\footnote{text}。敬之者昌，慢之者亡。无道行私，必得夭殃\footnote{text}。
	\end{yuanwen}
	...
	\begin{yuanwen}
	所谓气至而有效者\footnote{text}，泻则益虚。虚者，脉大如其故而不坚也。坚如其故者，适虽言快，病未去也。补则益实。实者，脉大如其故而益坚也。夫如其故而不坚者，适虽言快，病未去也。故补则实，泻则虚。痛虽不随针，病必衰去。必先通十二经脉之所生病，而后可得传于终始矣。故阴阳不相移，虚实不相倾，取之其经。
	\end{yuanwen}
	
	\begin{yuanwen}
	凡刺之属，三刺至谷气\footnote{text}。邪僻妄合\footnote{text}，阴阳易居。逆顺相反，沉浮异处\footnote{text}。四时不得\footnote{text}，稽留淫泆。须针而去。故一刺则阳邪出，再刺则阴邪出，三刺则谷气至，谷气至而止。所谓谷气至者，已补而实，已泻而虚，故以知谷气至也。邪气独去者，阴与阳未能调，而病知愈也。故曰：补则实，泻则虚。痛虽不随针，病必衰去矣。
	\end{yuanwen}
	...
	\begin{yuanwen}
	三脉动于足大指之间\footnote{text}，必审其实虚。虚而泻之，是谓重虚。重虚，病益甚。凡刺此者，以指按之。脉动而实且疾者则泻之，虚而徐者则补之。反此者，病益甚。其动也，阳明在上，厥阴在中，少阴在下。膺腧中膺，背腧中背。肩膊虚者，取之上\footnote{text}。重舌\footnote{text}，刺舌柱以铍针也\footnote{text}。手屈而不伸者，其病在筋；伸而不屈者，其病在骨。在骨守骨，在筋守筋。
	\end{yuanwen}
	
	\begin{yuanwen}
	泻一方实，深取之，稀按其痏\footnote{w\`ei}，以极出其邪气；补一方虚，浅刺之，以养其脉，疾按其痏\footnote{text}，无使邪气得入。邪气来也紧而疾，谷气来也徐而和。脉实者，深刺之，以泄其气；脉虚者，浅刺之，使精气无得出，以养其脉，独出其邪气。刺诸痛者，其脉皆实。
	\end{yuanwen}
	...
	\begin{yuanwen}
	春，气在毛；夏，气在皮肤；秋，气在分肉；冬，气在筋骨。刺此病者，各以其时为齐\footnote{text}。故刺肥人者，以秋冬之齐；刺瘦人者，以春夏之齐。病痛者，阴也。痛而以手按之不得者，阴也，深刺之\footnote{text}。病在上者，阳也。病在下者，阴也。痒者，阳也，浅刺之。
	\end{yuanwen}
	...
	\begin{yuanwen}
	凡刺之法，必察其形气。形肉未脱，少气而脉又躁，躁疾者，必为缪刺之。散气可收，聚气可布\footnote{text}。深居静处，占神往来，闭户塞牖，魂魄不散。专意一神，精气之分，毋闻人声，以收其精，必一其神，令志在针。浅而留之，微而浮之，以移其神，气至乃休。男内女外，坚拒勿出。谨守勿内，是谓得气。
	\end{yuanwen}
	...
	\begin{yuanwen}
	肺手太阴之脉，起于中焦\footnote{text}，下络大肠\footnote{text}，还循胃口\footnote{text}，上膈属肺\footnote{text}。从肺系横出腋下\footnote{text}，下循臑内\footnote{text}，行少阴心主之前，下肘中，循臂内，上骨下廉\footnote{text}，入寸口，上鱼\footnote{text}，循鱼际\footnote{text}，出大指之端；其支者，从腕后直出次指内廉，出其端。
	\end{yuanwen}
	...
	\begin{yuanwen}
	大肠手阳明之脉，起于大指次指之端，循指上廉，出合谷两骨之间\footnote{text}，上入两筋之中\footnote{text}，循臂上廉，入肘外廉，上臑外前廉，上肩，出髃\footnote{y\'u}骨之前廉\footnote{text}，上出于柱骨之会上\footnote{text}，下入缺盆络肺\footnote{text}，下膈属大肠。其支者，从缺盆上颈贯颊，入下齿中，还出挟口，交人中，左之右，右之左，上挟鼻孔。
	\end{yuanwen}
	...
	\begin{yuanwen}
	胃足阳明之脉，起于鼻之交頞中\footnote{text}，旁纳太阳之脉，下循鼻外，入上齿中，还出挟口，环唇，下交承浆，却循颐后下廉\footnote{text}，出大迎，循颊车，上耳前，过客主人，循发际，至额颅\footnote{text}；其支者，从大迎前下人迎，循喉咙，入缺盆，下膈，属胃，络脾；其直者，从缺盆下乳内廉，下挟脐，入气街中\footnote{text}；其支者，起于胃口，下循腹里，下至气街中而合，以下髀关，抵伏兔，下膝膑中，下循胫外廉，下足跗，入中指内间；其支者，下廉三寸而别，下入中指外间；其支者，别跗上，入大指间，出其端。
	\end{yuanwen}
	...
	\begin{yuanwen}
	脾足太阴之脉，起于大指之端，循指内侧白肉际\footnote{text}，过核骨后\footnote{text}，上内踝前廉，上踹内\footnote{text}，循胫骨后，交出厥阴之前，上膝股内前廉，入腹属脾络胃，上膈，挟咽，连吞本\footnote{text}，散舌下；其支者，复从胃，别上膈，注心中。
	...
	\begin{yuanwen}
	心手少阴之脉，起于心中，出属心系\footnote{text}，下膈络小肠；其支者，从心系上挟咽，系目系\footnote{text}；其直者，复从心系却上肺，下出腋下，下循臑内后廉，行太阴心主之后，下肘内，循臂内后廉，抵掌后锐骨之端\footnote{text}，入掌内后廉，循小指之内出其端。
	
	是动则病嗌干，心痛，渴而欲饮，是为臂厥。是主心所生病者，目黄，胁痛，臑臂内后廉痛厥，掌中热痛。为此诸病，盛则泻之，虚则补之，热则疾之，寒则留之，陷下则灸之，不盛不虚，以经取之。盛者，寸口大再倍于人迎，虚者，寸口反小于人迎也。
	\end{yuanwen}
	
	\begin{yuanwen}
	小肠手太阳之脉，起于小指之端，循手外侧上腕，出踝中\footnote{text}，直上循臂骨下廉，出肘内侧两筋之间，上循臑外后廉，出肩解\footnote{text}，绕肩胛，交肩上，入缺盆络心，循咽下膈，抵胃属小肠；其支者，从缺盆循颈上颊，至目锐眦\footnote{text}，却入耳中；其支者，别颊上䪼抵鼻\footnote{text}，至目内眦\footnote{text}，斜络于颧。
	
	是动则病嗌痛，颔肿，不可以顾，肩似拔，臑似折。是主液所生病者，耳聋、目黄，颊肿，颈、颔、肩、臑、肘、臂外后廉痛。为此诸病，盛则泻之，虚则补之，热则疾之，寒则留之，陷下则灸之，不盛不虚，以经取之。盛者，人迎大再倍于寸口，虚者，人迎反小于寸口也。
	\end{yuanwen}
	
	\begin{yuanwen}
	膀胱足太阳之脉，起于目内眦，上额交巅\footnote{text}；其支者，从巅至耳上角\footnote{text}；其直者，从巅入络脑，还出别下项，循肩髃\footnote{y\'u}内，挟脊抵腰中，入循膂\footnote{text}，络肾属膀胱；其支者，从腰中下挟脊贯臀，入腘中；其支者，从髆内左右，别下，贯胛，挟脊内，过髀枢\footnote{text}，循髀外，从后廉下合腘中，以下贯踹内，出外踝之后，循京骨\footnote{text}，至小指外侧。
	...
	\begin{yuanwen}
	心主手厥阴心包络之脉，起于胸中，出属心包络，下膈，历络三焦\footnote{text}；其支者，循胸出胁，下腋三寸，上抵腋，下循臑内\footnote{text}，行太阴少阴之间，入肘中，下臂行两筋之间，入掌中，循中指出其端；其支者，别掌中，循小指次指，出其端。
	...
	\begin{yuanwen}
	三焦手少阳之脉，走于小指次指之端，上出两指之间，循手表腕\footnote{text}，出臂外两骨之间，上贯肘，循臑外，上肩，而交出足少阳之后，入缺盆，布膻中，散落心包，下膈，循属三焦；其支者，从膻中上出缺盆，上项，系耳后直上，出耳上角，以屈下颊至䪼；其支者，从耳后入耳中，出走耳前，过客主人前，交颊，至目锐眦。
	...
	\begin{yuanwen}
	胆足少阳之脉，起于目锐眦，上抵头角，下耳后，循颈行手少阳之前，至肩上，却交出手少阳之后，入缺盆；其支者，从耳后入耳中，出走耳前，至目锐眦后；其支者，别锐眦，下大迎，合于手少阳，抵于䪼，下加颊车，下颈合缺盆，以下胸中，贯膈络肝属胆，循胁里，出气街，绕毛际\footnote{text}，横入髀厌\footnote{text}中；其直者，从缺盆下腋，循胸过季胁，下合髀厌中，以下循髀阳\footnote{text}，出膝外廉，下外辅骨之前\footnote{text}，直下抵绝骨\footnote{text}之端，下出外踝之前，循足跗上，入小指次指之间；其支者，别跗上，入大指之间，循大指歧骨内出其端，还贯爪甲，出三毛\footnote{text}。
	...
	\begin{yuanwen}
	肝足厥阴之脉，起于大指丛毛\footnote{text}之际，上循足跗上廉，去内踝一寸，上踝八寸，交出太阴之后，上腘内廉，循股阴入毛中，过阴器，抵小腹，挟胃属肝络胆，上贯膈，布胁肋，循喉咙之后，上入颃颡，连目系，上出额，与督脉会于巅；其支者，从目系下颊里，环唇内；其支者，复从肝别贯膈，上注肺。
	...
	\begin{yuanwen}
	经脉十二者，伏行分肉之间，深而不见；其常见者，足太阴过于外踝之上\footnote{text}，无所隐故也。诸脉之浮而常见者，皆络脉也。六经络手阳明少阳之大络，起于五指间，上合肘中。饮酒者，卫气先行皮肤，先充络脉，络脉先盛。故卫气已平，营气乃满，而经脉大盛。脉之卒然动者，皆邪气居之，留于本末，不动则热，不坚则陷且空，不与众同，是以知其何脉之动也。
	\end{yuanwen}
	...
	黄帝曰：诸络脉皆不能经大节之间，必行绝道而出\footnote{text}，入复合于皮中，其会皆见于外。故诸刺络脉者，必刺其结上\footnote{text}。甚血者虽无结，急取之以泻其邪而出其血。留之发为痹也。凡诊络脉，脉色青，则寒且痛；赤则有热。胃中寒，手鱼之络多青矣；胃中有热，鱼际络赤。其暴黑者，留久痹也。其有赤、有黑、有青者，寒热气也。其青短者，少气也。凡刺寒热者皆多血络，必间日而一取之，血尽而止，乃调其虚实。其小而短者少气，甚泻之则闷，闷甚则仆，不得言。闷则急坐之也。
	\end{yuanwen}
	...
	岐伯答曰：人受气于谷。谷入于胃，以传于肺，五脏六腑，皆以受气。其清者为营，浊者为卫，营在脉中，卫在脉外。营周不休，五十而复大会。阴阳相贯，如环无端。卫气行于阴二十五度，行于阳二十五度，分为昼夜。故气至阳而起，至阴而止。故曰：日中而阳陇为重阳，夜半而阴陇为重阴。故太阴主内，太阳主外，各行二十五度分为昼夜。夜半为阴陇，夜半后而为阴衰，平且阴尽，而阳受气矣。日中而阳陇\footnote{text}，日西而阳衰。日入阳尽，而阴受气矣。夜半而大会，万民皆卧，命曰合阴。平旦阴尽而阳受气。如是无已，与天地同纪。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：老人之不夜瞑者，何气使然？少壮之人不昼瞑者，何气使然？
	
	岐伯答曰：壮者之气血盛，其肌肉滑，气道通，营卫之行，不失其常，故昼精而夜瞑\footnote{text}。老者之气血衰，其肌肉枯，气道涩，五脏之气相博，其营气衰少而卫气内伐\footnote{text}，故昼不精，夜不瞑。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：愿闻营卫之所行，皆何道从来？
	
	岐伯答曰：营出于中焦，卫出于下焦\footnote{text}。
	
	黄帝曰：愿闻三焦之所出。
	
	岐伯答曰：上焦出于胃上口，并咽以上，贯膈而布胸中，走腋，循太阴之分而行，还至阳明，上至舌，下足阳明。常与营俱行于阳二十五度，行于阴亦二十五度，一周也。故五十度而复大会于手太阴矣\footnote{text}。
	...
	岐伯答曰：营卫者，精气也；血者，神气也。故血之与气，异名同类焉。故夺血者无汗，夺汗者无血。故人生有两死，而无两生\footnote{text}。
	\end{yuanwen}
	...
	\begin{yuanwen}
	黄帝曰：余闻先师，有所心藏，弗著于方\footnote{text}。余愿闻而藏之，则而行之。上以治民，下以治身，使百姓无病。上下和亲，德泽下流。子孙无优，传于后世。无有终时，可得闻乎？
	...
	岐伯曰：入国问俗，入家问讳，上堂问礼，临病人问所便\footnote{text}。
	...
	岐伯曰：便此者，食饮衣服，亦欲适寒温。寒无凄怆\footnote{text}，暑无出汗。食饮者，热无灼灼\footnote{text}，寒无沧沧\footnote{text}。寒温中适。故气将持。乃不致邪僻也。
	\end{yuanwen}
	...
	岐伯答曰：人亦有四海，十二经水\footnote{text}。经水者，皆注于海，海有东西南北，命曰四海。
	...
	岐伯答曰：必先明知阴阳表里荥腧所在\footnote{text}，四海定矣。
	\end{yuanwen}

	\begin{yuanwen}
	黄帝曰：定之奈何？
	
	岐伯曰：胃者，水谷之海\footnote{text}，其输上在气街，下至三里；冲脉者，为十二经之海\footnote{text}，其输上在于大杼，下出于巨虚之上下廉；膻中者，为气之海\footnote{text}，其输上在于柱骨之上下\footnote{text}，前在于人迎；脑为髓之海\footnote{text}，其输上在于其盖\footnote{text}，下在风府。
	\end{yuanwen}
	...
	岐伯曰：气海有余者，气满胸中，悗息面赤；气海不足，则气少不足以言。血海有余，则常想其身大，怫然不知其所病；血海不足，亦常想其身小，狭然不知其所病\footnote{text}。水谷之海有余，则腹满；水谷之海不足，则饥不受谷食。髓海有余，则轻劲多力，自过其度\footnote{text}；髓海不足，则脑转耳鸣，胫痠眩冒，目无所见，懈怠安卧。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：余已闻逆顺，调之奈何？
	
	岐伯曰：审守其输\footnote{text}，而调其虚实，无犯其害。顺者得复，逆者必败。
	...
	\begin{yuanwen}
	黄帝问于岐伯曰：余闻针道于夫子，众多毕悉矣。夫子之道应若失，而据未有坚然者\footnote{text}也。夫子之问学熟乎，将审察于物而心生之乎？
	
	岐伯曰：圣人之为道者，上合于天，下合于地，中合于人事。必有明法，以起度数，法式检押\footnote{text}，乃后可传焉。故匠人不能释尺寸而意短长，废绳墨而起平木也；工人不能置规而为圆，去矩而为方。知用此者，固自然之物，易用之教，逆顺之常也。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：愿闻自然奈何？
	
	岐伯曰：临深决水，不用功力，而水可竭也。循拙决冲\footnote{text}，而经可通也\footnote{text}。此言气之滑涩，血之清浊，行之逆顺也。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：愿闻人之白黑肥瘦少长，各有数乎？
	
	岐伯曰：年质壮大，血气充盈，肤革坚固，因加以邪。刺此者，深而留之，此肥人也。广肩腋项，肉薄厚皮而黑色，唇临临然\footnote{text}，其血黑以浊，其气涩以迟。其为人也，贪于取与。刺此者，深而留之，多益其数也。
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：刺瘦人奈何？
	
	岐伯曰：瘦人者，皮薄色少，肉廉廉然\footnote{text}，薄唇轻言。其血清气滑，易脱于气，易损于血。刺此者，浅而疾之。
	\end{yuanwen}
	...
	岐伯曰：刺壮士真骨\footnote{text}，坚肉缓节监监然\footnote{text}，此人重则气涩血浊，刺此者，深而留之，多益其数；劲则气滑血清，刺此者，浅而疾之。
	\end{yuanwen}
	...
	\begin{yuanwen}
	黄帝曰：余受九针于夫子，而私览于诸方。或有导引行气\footnote{text}，按摩、灸、熨、刺、焫\footnote{ru\`o}、饮药之一者，可独守耶，将尽行之乎？
	
	岐伯曰：诸方者，众人之方也，非一人之所尽行也。	
	\end{yuanwen}
	
	\begin{yuanwen}
	黄帝曰：此乃所谓守一勿失，万物毕者也\footnote{text}。今余已闻阴阳之要，虚实之理，倾移之过，可治之属。愿闻病之变化，淫传绝败而不可治者，可得闻乎？
	...
	岐伯曰：瘖乎其无声，漠乎其无形。折毛发理，正气横倾。淫邪泮衍\footnote{text}，血脉传溜。大气入藏\footnote{text}，腹痛下淫\footnote{text}。可以致死，不可以致生。
	\end{yuanwen}
	...
	\begin{yuanwen}
	病先发于脾，一日而之胃，二日而之肾，三日而之膀胱。十日不已，死。冬人定\footnote{text}，夏晏食。
	\end{yuanwen}
